...
namespace phi
{
    ...
    controlRenderer* controlRenderer::configure(gl* gl, float width, float height, const string& resourcesPath, controlRendererDescriptor* renderDescriptor)
    {
        ...
        return new controlRenderer({controlRenderPass});
    }
}