...
namespace phi
{
    inline textRenderer::textRenderer(const gl* const gl, float w, float h) :
        _gl(gl),
        _w(w),
        _h(h)
    {
    ...
    void textRenderer::createVbo(void* const data, GLsizeiptr size)
    {
    ...
    void textRenderer::createGlyphIdsBuffer()
    {
        vector<vertexAttrib> attribs;
    ...
    void textRenderer::createModelMatricesBuffer()
    {
        vector<vertexAttrib> attribs;
    ...
    void textRenderer::addText(wstring text, vec2 position, font* const  font)
    {
