...
void screen::initScene()
{
    ...
    //chair0->yaw(0.3);
    //chair0->setOrientation(glm::vec3(0.0f, 1.0f, 0.0f));
    //s->add(chair0);
    ...
    */
    ...
    phi::spotLight* spotLight0 = new phi::spotLight(glm::vec3(-2.0f, 2.0f, 0.0f), phi::color::fromRGBA(1.0, 0.9, 0.7, 1.0), 1.0f, 5.0f, dir, 0.8f);
    s->add(spotLight0);
