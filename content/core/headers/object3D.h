...
namespace phi
{
    ...
    public:
        ...
        CORE_API glm::quat getQuaternion() const { return _orientation; }
        ...
        CORE_API void setOrientation(glm::quat value) { _orientation = value; _changed = true; }
        CORE_API void setOrientation(glm::vec3 direction);
